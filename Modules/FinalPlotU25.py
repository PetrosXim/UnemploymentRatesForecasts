...
def FinalPlotU25():
    Greece = read_excel('DtU25.xls', sheet_name='Greece', header=0, 
              index_col=0, parse_dates=True, squeeze=True)  
    Portugal = read_excel('DtU25.xls', sheet_name='Portugal', header=0, 
              index_col=0, parse_dates=True, squeeze=True)     
    Netherlands = read_excel('DtU25.xls', sheet_name='Netherlands', header=0, 
              index_col=0, parse_dates=True, squeeze=True) 
    Latvia = read_excel('DtU25.xls', sheet_name='Latvia', header=0, 
              index_col=0, parse_dates=True, squeeze=True) 
    Poland = read_excel('DtU25.xls', sheet_name='Poland', header=0, 
              index_col=0, parse_dates=True, squeeze=True) 
    ...
    plt.legend(loc=2)
    plt.title('Comparison plot for the forecasts of the U25 unemployment rates of active population in Greece', fontsize=12)
    plt.xlabel('Date')
    ...
    plt.legend(loc=2)
    plt.title('Comparison plot for the forecasts of the U25 unemployment rates of active population in Portugal', fontsize=12)
    plt.xlabel('Date')
    plt.ylabel('Unemployment Rate')
    plt.show()
    ...
    plt.legend(loc=2)
    plt.title('Comparison plot for the forecasts of the U25 unemployment rates of active population in Netherlands', fontsize=12)
    plt.xlabel('Date')
    plt.ylabel('Unemployment Rate')
    plt.show()
    ...
    plt.legend(loc=2)
    plt.title('Comparison plot for the forecasts of the U25 unemployment rates of active population in Latvia', fontsize=12)
    plt.xlabel('Date')
    plt.ylabel('Unemployment Rate')
    plt.show()
    ...
    plt.legend(loc=2)
    plt.title('Comparison plot for the forecasts of the U25 unemployment rates of active population in Poland', fontsize=12)
    plt.xlabel('Date')
    plt.ylabel('Unemployment Rate')
    plt.show()
    return 